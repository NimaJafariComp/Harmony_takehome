...
| M4.8 Test workflow invariants | `in_progress` | AC-08, AC-09 | Verification-only task: focused invariant coverage is being added without a production-code RED cycle. |
