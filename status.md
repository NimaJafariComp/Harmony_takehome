...
| M3.4 Implement candidate filtering | `in_progress` | AC-05 | - |
...
| 2026-08-25 | M3.4 | Started deterministic supplier-candidate filtering coverage. | Test: `tests/test_supplier_candidates.py` - RED because the candidate filter and auditable exclusion contracts do not exist. | Pending RED checkpoint. |
