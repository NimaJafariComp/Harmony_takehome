...
| M5.3 Implement end-of-day approval routing | `in_progress` | AC-07 | TDD contracts for deterministic escalation scheduling, next-day out-of-office evidence, backup authority, immutable plan-hash preservation, and atomic rerouting are being added. |
