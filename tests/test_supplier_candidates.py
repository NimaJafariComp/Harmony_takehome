...
def test_seeded_filter_exposes_only_supplier_z_as_the_allowed_alternate(
    ...
    command = (
        ...
        "detection = StockoutDetector(PostgresErpAdapter(database_url), PostgresAttentionAdapter(database_url)).detect(actor, RunId('run-seeded-candidates'), datetime(2026, 8, 24, 9, tzinfo=UTC))[0]\n"
